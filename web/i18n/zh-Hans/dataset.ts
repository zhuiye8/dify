const translation = {
  ...
  externalAPIPanelDescription: '外部知识库 API 用于连接到 Nature 之外的知识库并从中检索知识。',
  ...
  connectDatasetIntro: {
    title: '如何连接到外部知识库',
    content: {
      front: '要连接到外部知识库，您需要先创建一个外部 API。',
      link: '了解如何创建外部 API',
  ...
  connectHelper: {
    helper1: '通过 API 和知识库 ID 连接到外部知识库。',
    helper2: '仅支持检索功能',
