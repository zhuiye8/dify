const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Nature account',
    langGeniusAccountTip: 'Your Nature account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Nature to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Nature allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Nature\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Nature {{version}} is now available.',
    latestAvailable: 'Nature {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
