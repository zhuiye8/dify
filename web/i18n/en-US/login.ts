const translation = {
  ...
  welcome: '👋 Welcome to Nature, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Nature Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Nature',
  invalid: 'The link has expired',
  explore: 'Explore Nature',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Nature and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Nature Enterprise license for your workspace has expired. Please contact your administrator to continue using Nature.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Nature license server. Please contact your administrator to continue using Nature.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Nature Enterprise license for your workspace is inactive. Please contact your administrator to continue using Nature.',
}
