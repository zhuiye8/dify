const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto Nature',
    langGeniusAccountTip: 'Twoje konto Nature i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Nature, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Nature pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Nature.',
  ...
  about: {
    ...
    nowAvailable: 'Nature {{version}} jest teraz dostępny.',
    latestAvailable: 'Nature {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
