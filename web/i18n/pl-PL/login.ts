const translation = {
  ...
  welcome: 'Witaj w Nature, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej Nature, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na Nature',
  invalid: 'Link wygasł',
  explore: 'Odkryj Nature',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w Nature, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja Nature Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z Nature.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji Nature. Skontaktuj się z administratorem, aby kontynuować korzystanie z Nature.',
  licenseInactiveTip: 'Licencja Nature Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z Nature.',
}
