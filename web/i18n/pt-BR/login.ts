const translation = {
  ...
  welcome: 'Bem-vindo ao Nature, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Nature, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Nature',
  invalid: 'O link expirou',
  explore: 'Explorar o Nature',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no Nature e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do Nature Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o Nature.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças Nature. Entre em contato com o administrador para continuar usando o Nature.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do Nature Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o Nature.',
}
