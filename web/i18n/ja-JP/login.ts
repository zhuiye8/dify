const translation = {
  pageTitle: 'はじめましょう！👋',
  welcome: 'Natureへようこそ。続行するにはログインしてください。',
  email: 'メールアドレス',
  ...
  license: {
    tip: 'GitHubのオープンソースライセンスを確認してから、Nature Community Editionを開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  resetPasswordDesc: 'Natureへのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。',
  licenseLost: 'ライセンスを失った',
  licenseExpiredTip: 'ワークスペースの Nature Enterprise ライセンスの有効期限が切れています。Natureを引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの Nature Enterprise ライセンスが非アクティブです。Natureを引き続き使用するには、管理者に連絡してください。',
  licenseExpired: 'ライセンスの有効期限が切れています',
  licenseLostTip: 'Natureライセンスサーバーへの接続に失敗しました。続けてNatureを使用するために管理者に連絡してください。',
}
