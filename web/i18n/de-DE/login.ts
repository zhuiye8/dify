const translation = {
  ...
  welcome: 'Willkommen bei Nature, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit Nature Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Nature beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Nature erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei Nature angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des Nature-Lizenzservers. Wenden Sie sich an Ihren Administrator, um Nature weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die Nature Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um Nature weiterhin zu verwenden.',
  licenseExpiredTip: 'Die Nature Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um Nature weiterhin zu verwenden.',
