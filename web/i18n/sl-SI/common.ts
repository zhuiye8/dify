const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Nature račun',
    langGeniusAccountTip: 'Vaš Nature račun in povezani uporabniški podatki.',
    editName: 'Uredi ime',
  ...
  members: {
    ...
    invitationSentTip: 'Povabilo poslano, in po prijavi v Nature bodo imeli dostop do vaših podatkov ekipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Gostitvena storitev OpenAI, ki jo ponuja Nature, vam omogoča uporabo modelov, kot je GPT-3.5. Preden porabite kvoto za preizkus, morate nastaviti druge ponudnike modelov.',
  ...
  modelProvider: {
    ...
    apiBasedExtension: {
      title: 'Razširitve API omogočajo centralizirano upravljanje API, kar poenostavi konfiguracijo za enostavno uporabo v aplikacijah Nature.',
    ...
    about: {
      ...
      nowAvailable: 'Nature {{version}} je zdaj na voljo.',
      latestAvailable: 'Nature {{version}} je najnovejša različica na voljo.',
    },
    appMenus: {
      overview: 'Nadzor',
  ...
  apiBasedExtension: {
    ...
    title: 'Razširitve API zagotavljajo centralizirano upravljanje API, kar poenostavlja konfiguracijo za enostavno uporabo v aplikacijah Nature.',
    linkUrl: 'https://docs.dify.ai/features/extension/api_based_extension',
  ...
  about: {
    updateNow: 'Posodobi zdaj',
    nowAvailable: 'Nature {{version}} je zdaj na voljo.',
    latestAvailable: 'Nature {{version}} je najnovejša različica, ki je na voljo.',
    changeLog: 'Dnevnik sprememb',
  },
  appMenus: {
