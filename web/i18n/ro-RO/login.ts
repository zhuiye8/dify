const translation = {
  ...
  welcome: 'Bine ai venit la Nature, te rugăm să te autentifici pentru a continua.',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe Nature și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe Nature. Contactați administratorul pentru a continua să utilizați Nature.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența Nature Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați Nature.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența Nature Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați Nature.',
}
