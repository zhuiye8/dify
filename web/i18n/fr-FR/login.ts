const translation = {
  ...
  welcome: 'Bienvenue sur Nature, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Nature Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Nature',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Nature',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur Nature et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence Nature Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser Nature.',
  licenseLostTip: 'Échec de la connexion au serveur de licences Nature. Veuillez contacter votre administrateur pour continuer à utiliser Nature.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence Nature Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser Nature.',
